...
function add_search_nav_item($items, $args) {
	if($args->theme_location == 'header-menu') {
		...
		$items .= '<li class="menu-item hide-menu"><a target="_blank" class="facebook-wrapper" href="https://www.spd.de"><img src="https://marianne-schieder.de/wp-content/uploads/2019/08/spd-logo-75x75.png" class="menu-spd"/></a></li>';

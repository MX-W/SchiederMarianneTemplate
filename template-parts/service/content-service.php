                    ...
                    <table class="table-service-form">
                        ...
                        <tr>
                            <td>
                                <div class="row">
                                    <div class="col-lg-5">
                                        <input name="sm_name" value="<?php if(isset($_POST['name'])) { echo $_POST['name'];}?>" placeholder="Name*" class="input-service" type="text" required/>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-5">
                                        <input name="sm_email" value="<?php if(isset($_POST['email'])) { echo $_POST['email'];}?>" placeholder="E-Mail*" class="input-service" tpye="text" required />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input name="sm_subject" value="<?php if(isset($_POST['subject'])) { echo $_POST['subject'];}?>" placeholder="Betreff*" class="input-service" type="text" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <textarea name="sm_text" placeholder="Ihre Nachricht*" rows="7" cols="100" class="input-service" required ><?php if(isset($_POST['text'])) { echo $_POST['text'];}?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="recaptcha-wrapper">
                                    <div class="g-recaptcha" data-sitekey="6Lca4nUUAAAAAGALCsqq11Gei9GYywsKyjSo-Yoj"></div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input id="service-submit" name="sm_submit" value="Absenden" class="input-submit" type="submit" style="cursor: pointer;"/>
                            </td>
                        </tr>
